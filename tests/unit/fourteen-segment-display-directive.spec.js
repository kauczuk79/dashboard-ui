describe('Fourteen segment display directive', function () { 
	var HTML_WITH_REQUIRED_ATTRIBUTES = '<g class="fourteen-segment-display" data-digits="3" data-value="123"></g>',
		HTML_WITH_ALL_ATTRIBUTES = '<g class="fourteen-segment-display" data-digits="3" data-value="123" data-x="5" data-y="10" data-show-background="true"></g>',
		$compile,
		$scope;
